...
const BandShow = (props) =>  {
  ...
  return (
    ...
    <Row lg={12}>      
      { loading ? <Spinner animation="grow" /> : <Col  lg={{span: 3, order: 1}} md={{ span: 6, order: 1}} sm={{ span: 12, order: 1}} xs={{ span: 12, order: 1}}> 
      ...
      { loading ? <Spinner animation="grow" /> : <Col lg={{span: 5, order: 4}} md={{ span: 12, order: 12}} sm={{ span: 12, order: 12}} xs={{ span: 12, order: 12}}>
        <Row>
             <BandCard {...band}/>
        </Row>
      </Col> }

      { loading ? <Spinner animation="grow" /> : <Col lg={{span: 3, order: 12}} md={{ span: 6, order: 4}} sm={{ span: 12, order: 2}} xs={{ span: 12, order: 2}}> 
